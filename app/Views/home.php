...
<section class="hero-burjo">
    <div class="container py-5 text-center">
        ...
        <p class="lead text-muted mb-4">Senyaman rumah, seakrab sahabat. Tempat terbaik nikmatin makanan dan minuman favoritmu kapan pun kamu butuh.</p>
                        ...
                        <div class="card menu-card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (! empty($item['deskripsi'])) : ?>
                                    <p class="card-text text-muted small mb-0"><?= esc($item['deskripsi']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
